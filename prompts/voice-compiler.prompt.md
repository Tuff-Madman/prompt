---
name: voice-compiler
description: Compiles a raw voice archive into a compact, high-fidelity about-me Markdown context file for future AI sessions, preserving only behavior-changing voice laws, examples, taste signals, refusals, decision rules, phrase patterns, and productive contradictions.
when_to_use: Use when the user provides a raw voice archive, taste interview output, style notes, or personal calibration material and wants it compressed into an AI-readable standing-context about-me file.
arguments:
